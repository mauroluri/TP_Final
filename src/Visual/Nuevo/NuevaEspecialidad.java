...
public class NuevaEspecialidad extends javax.swing.JInternalFrame {

    Controladora cLocal;
    
    public NuevaEspecialidad(Controladora c) {
        initComponents();
        cLocal = c;
        String nom = c.dameEmpresas().get(0).getNombre();
        setTitle(nom+" - NuevaEspecialidad");
    }
    ...
    private void initComponents() {
        ...
        jPanelNuevoModelo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nueva Especialidad", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 36), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(!txtNombre.getText().equals("")){
            try {
                ...
                cLocal.crearEspecialidad(nombre);
                this.hide();
                ...
                String err = "Ya existe esa Especialidad.";
                System.err.println(err);
