...
public class NuevoNivelImportancia extends javax.swing.JInternalFrame {

    Controladora cLocal;
    
    public NuevoNivelImportancia(Controladora c) {
        initComponents();
        cLocal = c;
        String nom = c.dameEmpresas().get(0).getNombre();
        setTitle(nom+" - Nuevo Nivel de Importancia");
    }
    ...
    private void initComponents() {
        ...
        jPanelNuevoModelo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nuevo Nivel de Importancia", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 36), new java.awt.Color(0, 0, 0))); // NOI18N

        jPanelDNI.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 0, 0), null));

        lblNombre.setText("Nombre del estado:");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(!txtNombre.getText().equals("")){
            try {
                ...
                cLocal.crearNivelImportancia(nombre);
                this.hide();
                ...
                String err = "Ya existe ese Nivel de Importancia.";
                System.err.println(err);
