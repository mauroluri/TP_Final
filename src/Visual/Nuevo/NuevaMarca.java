...
public class NuevaMarca extends javax.swing.JInternalFrame {

    Controladora cLocal;
    
    public NuevaMarca(Controladora c) {
        initComponents();
        cLocal = c;
        String nom = c.dameEmpresas().get(0).getNombre();
        setTitle(nom+" - Nueva Marca");
    }
    ...
    private void initComponents() {
        ...
        jPanelNuevoModelo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nueva Marca", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 36), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(!txtNombre.getText().equals("")){
            try {
                ...
                boolean b=true;
                Marca seg;
                List<Marca> s= cLocal.dameMarcas();
                Iterator<Marca> it = s.iterator();

                while(it.hasNext() && b) {
                    seg = it.next();
                    if(seg.getNombre().equals(txtNombre.getText())){ b=false; }
                }
                cLocal.crearMarca(nombre);
                this.hide();
                ...
                String err = "Ya existe esa Marca.";
                System.err.println(err);
