...
public class NuevaCategoria extends javax.swing.JInternalFrame {
    ...
    public NuevaCategoria(Controladora c) {
        initComponents();
        cLocal = c;
        String nom = c.dameEmpresas().get(0).getNombre();
        setTitle(nom+" - Nueva Categoria");
    }
    ...
    private void initComponents() {
        ...
        jPanelNuevoModelo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nueva Categoria de Actividades", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 36), new java.awt.Color(0, 0, 0))); // NOI18N
