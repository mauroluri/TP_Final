...
public class NuevoSegmento extends javax.swing.JInternalFrame {

    Controladora cLocal;
    
    public NuevoSegmento(Controladora c) {
        initComponents();
        cLocal = c;
        String nom = c.dameEmpresas().get(0).getNombre();
        setTitle(nom+" - Nuevo Segmento");
    }
    ...
    private void initComponents() {
        ...
        jPanelNuevoModelo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nuevo Segmento", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 36), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(!txtNombre.getText().equals("")){
            try {                
                ...
                boolean b=true;
                Segmento seg;
                List<Segmento> s= cLocal.dameSegmentos();
                Iterator<Segmento> it = s.iterator();

                while(it.hasNext() && b) {
                    seg = it.next();
                    if(seg.getNombre().equals(txtNombre.getText())){ b=false; }
                }  
                cLocal.crearSegmento(nombre);
                this.hide();
                ...
                String err = "Ya existe ese Segmento.";
                System.err.println(err);
